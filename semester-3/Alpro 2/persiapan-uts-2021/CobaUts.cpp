...
struct spdam{
    char nopelanggan[5], tipe;
    string nama, kettipe;
    int byadm, jmlpakai, bypajak, bypotongan, hrg, totalbayar;
} datatagihan[n];
...
void main(){
    ...
    while (jml<n) {
        ...
        datatagihan[jml].totalbayar = datatagihan[jml].byadm + datatagihan[jml].bypajak + datatagihan[jml].jmlpakai - datatagihan[jml].bypotongan;
        jml++;
