	...
	<div class="utama">
		...
		<div class="row">
			<div class="col-sm-3 text-center">
				...
				<div>
					[ <a href="06476gantiFotoMhs.php?id=<?php echo $row['id'] ?>">Ganti Foto</a> ]
				</div>
			</div>
			<div class="col-sm-9">
				<form enctype="multipart/form-data" method="post" action="06476sv_editMhs.php">
