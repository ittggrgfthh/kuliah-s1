...
<body>
	...
	<div class="utama">
		...
		<div class="text-center"><a href="06476prnMhsPdf.php"><span class="fas fa-print">&nbsp;Print</span></a></div>
		<span class="float-left">
			<a class="btn btn-success" href="06476addMhs.php">Tambah Data</a>
		</span>
				...
				?>
					...
					?>
						<tr>
							...
							<td>
								<a class="btn btn-outline-primary btn-sm" href="06476editMhs.php?kode=<?php echo $row['id'] ?>">Edit</a>
								<a class="btn btn-outline-danger btn-sm" href="06476hpsMhs.php?kode=<?php echo $row["id"] ?>" id="linkHps" onclick="return confirm('Yakin dihapus nih?')">Hapus</a>
							</td>
						</tr>
				<?php
						$no++;
