...
public class FrameBarang extends JFrame {
    ...
    public FrameBarang() {
        ...
        tabel.setBackground(new Color(100, 90, 255));
        ...
        addButton.addActionListener(
                new AddController(this, addButton, fieldController, buttonController, tableController));
        searchButton.addActionListener(
                new SearchController(this, searchButton, fieldController, buttonController, tableController));
        updateButton.addActionListener(
                new UpdateController(this, updateButton, fieldController, buttonController, tableController));
        deleteButton.addActionListener(
                new DeleteController(this, deleteButton, fieldController, buttonController, tableController));
        ...
        getContentPane().add(desktopPane).setBackground(new Color(15, 0, 250));
