...
public class FrameMenu extends JFrame {
    ...
    public FrameMenu() {
        ...
        nameLabel.setFont(AppConfig.setFont.BIG_ARIAL);
        nameLabel.setForeground(AppConfig.setColor.LIGHT_BLUE);

        addressLabel.setFont(new Font("Verdana", Font.PLAIN, 15));
        addressLabel.setForeground(AppConfig.setColor.LIGHT_GREEN);
    ...
    class OpenAction implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            JOptionPane.showMessageDialog(FrameMenu.this, "Tidak bisa dibuka!");
        }
    }
